        ...
        function recordPatients(data)
        {
          ...
          patients.people1.data.every(
            function(x)
            {
              ...
              var command = 'say -r 150 "' + fullName + '" -o "/Users/fmason/PatientIdentificationUserStudy/patientId/files/' + fullName + '.mp4"';
              ...
              data.models.patient.create(patient, createPatient);

              return true;

              function createPatient(error, data)
              {
                if(error)
                {
                  console.log('createPatient - error:' + util.inspect(error));
                  return;
                }

                console.log( 'createPatient - patient created: ' + util.inspect(data));
              }
            }
          );
